...
<head>
<meta charset="utf-8">
<title>Crepeau Painting - Careers</title>
...
<header>
	...
	<div id="careers-header">
		Want to start working for a premier painting company?<br>
	</div>
	<div id="careers-form">
		...
		<?php
			...
			if(empty($name) || empty($email) || empty($phone) || strlen($name) > 40 || strlen($email) > 50 || strlen($phone) > 15){
				header('Location: careers_error.html');
				exit;
			}
			...
			$sql = "INSERT INTO candidate_table (Name, Email, Phone)
